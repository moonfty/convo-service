...
export const mongoDbConnectionString =
    process.env.NODE_ENV === 'development'
        ...
        : `mongodb+srv://${MONGO_USERNAME}:${MONGO_PASSWORD}@ec2-3-127-135-219.eu-central-1.compute.amazonaws.com:27017,ec2-52-59-218-12.eu-central-1.compute.amazonaws.com:27017,ec2-3-69-45-11.eu-central1.compute.amazonaws.com:27017/?replicaSet=s0`